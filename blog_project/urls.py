...
urlpatterns = [
    # 1. Admin MUST be at the top
    path('admin/', admin.site.urls), 
    
    # 2. Specific API/Validation paths
    ...
    path('account/logout/', user_views.logout_view, name='logout'),  
    
    # 5. Password Resets & 2FA
    ...
    path('2fa-verify/', user_views.two_factor_verify, name='2fa-verify'),
    path('account/security-audit/', user_views.security_audit, name='security-audit'),  

    # 6. The "Greedy" Profile path MUST be last
